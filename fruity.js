...
if (code == 37) { // left
marker.position.x = marker.position.x-25;
is_moving_left = true;
}
if (code == 38) { // up
marker.position.z = marker.position.z-25;
...
if (detectCollisions()) {
if (is_moving_left) marker.position.x = marker.position.x+25;
if (is_moving_right) marker.position.x = marker.position.x-25;
if (is_moving_forward) marker.position.z = marker.position.z+25;
if (is_moving_back) marker.position.z = marker.position.z-25;
}
});
